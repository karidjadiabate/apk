...
Route::prefix('admin')->middleware(['auth', 'admin', 'checkFromDemandeInscription', 'changepassword'])->group(function () {
    ...
    Route::put('filiere/activate/{id}', [FiliereEtablissementController::class, 'activate'])->name('activateadmin.filiere');
    Route::put('matiere/activate/{id}', [MatiereEtablissementController::class, 'activate'])->name('activateadmin.matiere');
