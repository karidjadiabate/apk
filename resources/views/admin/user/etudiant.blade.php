                    ...
                    @foreach ($etudiants as $etudiant)
                        <tr>
                            ...
                            <td data-label="Date-naissance">
                                {{ \Carbon\Carbon::parse($etudiant->datenaiss)->format('d - m - Y') }}</td>
                                                    ...
                                                    <select name="filiere_id" id="filiere_id" class="form-control"
                                                        ...
                                                        @foreach ($listefilieres as $filiere)
                                                            <option value="{{ $filiere->id }}"
                                                                @if ($filiere->id == $etudiant->filiere_id) selected @endif>
                                    ...
                                    <select name="filiere_id" id="filiere_id" class="form-control" required>
                                        ...
                                        @foreach ($listefilieres as $filiere)
                                            <option value="{{ $filiere->filiere_id }}">
                                                {{ $filiere->nomfiliere ?? $filiere->nomfilieretablissement }}</option>
                                        @endforeach
                                    </select>
                                    <div class="invalid-feedback"></div>
                                </div>
