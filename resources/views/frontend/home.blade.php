  ...
  <section id="hero" class="d-flex justify-content-center align-items-center mt-5">
    ...
    <div class="col-md-6 text-head d-flex justify-content-end">
      <div class="text-car w-75 d-flex align-items-center justify-content-start text-start flex-column">
        ...
        <p class="text-carousel">La solution innovante qui facilite et garantit l'intégrité de la génération et la correction de tout type d'évaluations scolaires.<br>Ne laissez pas les erreurs et la tricherie ternir vos efforts et baisser le niveau scolaire de vos élèves. Suivez les résultats en temps réel et faites confiance à notre technologie embarquée.<br>Fini le stress, concentrez-vous sur ce qui compte vraiment, la formation de vos élèves.</p>
      ...
      <span class="circle"></span>
        ...
        <div class="item active item1" data-slide-item="0" style="margin-top:11rem">
          <div class="carousel-container">
            <p class="img-carousel animated fadeInUp" ><img src="{{ asset('assets/img/Prof_mod(2).png') }}" alt="User 1" srcset=""></p>
          </div>
        </div>
        ...
        <div class="item item2"  data-slide-item="1" style="margin-top:11rem">
          <div class="carousel-container">
            <p class="animated fadeInUp" ><img src="{{ asset('assets/img/Student_2_mod(2).png') }}"  alt="User 2" srcset=""></p>
          </div>
        </div>
        ...
        <div class="item item3"  data-slide-item="2"  style="margin-top:15rem">
          <div class="carousel-container">
            <p class="animated fadeInUp"><img src="{{ asset('assets/img/scanner-final-en-GIF-compresser.gif') }}" height="450" width="auto" alt="Imprimante" srcset=""></p>
          </div>
        </div>
  ...
  <main id="main">
    ...
    <section>
        <video class="bg-video" autoplay muted loop>
          <source src="{{ asset('assets/video/RomNote-v3 (WEBM).webm') }}" type="video/webm">
          <source src="{{ asset('assets/video/RomNote v3.mp4') }}" type="video/mp4">
        </video>
        ...
        <div class="container">
            <div class="row d-flex flex-wrap justify-content-between">
                ...
                <div class="col-lg-4 col-md-6 mb-4">
                    <h3><span class="navbar-title">ROM</span>Note</h3>
